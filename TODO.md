...
- [ ] `skills/websec0/SKILL.md` (frontmatter + workflow + exemples §10.2)
- [ ] `skills/websec0/scripts/scan.sh` (wrapper curl ou CLI)
- [ ] `skills/websec0/scripts/apply_remediation.sh` (snippet picker pour stack donné)
- [ ] `skills/websec0/references/api.md` (référence API complète)
- [ ] `skills/websec0/references/checks.md` (généré depuis `GET /api/v1/checks`)
- [ ] `skills/websec0/references/stacks.md` (mapping stack → conventions snippet)
- [ ] `skills/websec0/references/safety.md` (règles éthiques étendues)
