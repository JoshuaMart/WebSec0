...
- [x] `HEADER-CSP-MISSING` — fail path returns no Evidence; pass path only the raw header without parsed directives. Tags: a,b (headers/csp.go:96)
- [x] `HEADER-CSP-UNSAFE-INLINE` — pass and fail return nil/empty Evidence (no list of directives carrying `'unsafe-inline'`). Tags: a (headers/csp.go:150)
- [x] `HEADER-CSP-UNSAFE-EVAL` — pass and fail return nil/empty Evidence. Tags: a (headers/csp.go:177)
- [x] `HEADER-CSP-WILDCARD-SRC` — pass path returns nil; fail path shows only directive name, not the actual `*` source. Tags: a,b (headers/csp.go:204)
- [x] `HEADER-CSP-NO-OBJECT-SRC` — fail path returns nil Evidence. Tags: a (headers/csp.go:234)
- [x] `HEADER-CSP-NO-BASE-URI` — pass and fail return nil Evidence. Tags: a (headers/csp.go:263)
- [x] `HEADER-CSP-NO-FRAME-ANCESTORS` — pass and fail return nil Evidence. Tags: a (headers/csp.go:290)
- [x] `HEADER-XCTO-MISSING` — pass and fail return nil Evidence (header value not stored). Tags: a (headers/security_headers.go:23)
- [x] `HEADER-XFO-MISSING` — most paths return nil Evidence; only the bad-value fail case records anything. Tags: a (headers/security_headers.go:54)
- [x] `HEADER-REFERRER-POLICY-MISSING` — fail path returns nil Evidence; pass has the value. Tags: a (headers/security_headers.go:109)
- [x] `HEADER-REFERRER-POLICY-UNSAFE` — both fail and warn carry `value`, but neither labels which token is unsafe. Tags: b (headers/security_headers.go:138)
- [x] `HEADER-PERMISSIONS-POLICY-MISSING` — fail path returns nil Evidence. Tags: a (headers/security_headers.go:180)
- [x] `HEADER-FEATURE-POLICY-DEPRECATED` — warn and pass return nil Evidence (deprecated header value not stored). Tags: a (headers/security_headers.go:211)
- [x] `HEADER-COOP-MISSING` — fail returns nil Evidence (presence-check helper). Tags: a (headers/security_headers.go:241)
- [x] `HEADER-COEP-MISSING` — fail returns nil Evidence. Tags: a (headers/security_headers.go:258)
- [x] `HEADER-CORP-MISSING` — fail returns nil Evidence. Tags: a (headers/security_headers.go:275)
- [x] `HEADER-REPORTING-ENDPOINTS-NONE` — fail path returns nil Evidence. Tags: a (headers/security_headers.go:294)
- [x] `HEADER-NEL-NONE` — fail returns nil Evidence. Tags: a (headers/security_headers.go:328)
- [x] `HEADER-XSS-PROTECTION-DEPRECATED` — pass and fail return nil Evidence; only warn has a value. Tags: a (headers/deprecated.go:23)
- [x] `HEADER-HPKP-DEPRECATED` — pass / fail / warn return nil Evidence. Tags: a (headers/deprecated.go:55)
- [x] `HEADER-EXPECT-CT-DEPRECATED` — pass returns nil Evidence; only warn has the value. Tags: a (headers/deprecated.go:90)
- [x] `HEADER-INFO-SERVER` — pass returns nil Evidence (no record of which `Server` header was inspected). Tags: a (headers/info_disclosure.go:35)
- [x] `HEADER-INFO-X-POWERED-BY` — pass returns nil Evidence. Tags: a (headers/info_disclosure.go:71)
- [x] `HEADER-INFO-X-ASPNET-VERSION` — pass returns nil Evidence. Tags: a (headers/info_disclosure.go:78)
- [x] `HEADER-INFO-X-GENERATOR` — pass returns nil Evidence. Tags: a (headers/info_disclosure.go:85)
- [x] `HEADER-INFO-SERVER-TIMING` — pass returns nil Evidence. Tags: a (headers/info_disclosure.go:92)
